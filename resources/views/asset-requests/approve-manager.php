...
<div class="mb-6">
    ...
    <p class="text-gray-600">Review and approve asset requests submitted by your subordinates in the department</p>
    <p class="text-sm text-blue-600 mt-2"><strong>ℹ️ You are the first approver.</strong> After your approval, requests will be forwarded to the IT Manager for further review.</p>
</div>
...
<div id="approvalModal" class="hidden fixed z-10 inset-0 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="relative bg-white rounded-lg max-w-lg w-full p-6">
            ...
            <form id="approvalForm" action="/asset-requests/manager-approvals/process" method="POST">
