...
$content = <<<HTML
<div class="mb-6">
    <h1 class="text-3xl font-bold mb-2">IT Manager Approvals</h1>
    <p class="text-gray-600">Review and approve asset requests (already approved by Department Managers)</p>
</div>
    ...
    <table class="min-w-full divide-y divide-gray-200 data-table">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Dept Mgr</th>
        ...
        $content .= <<<HTML
            <tr>
                <td class="px-6 py-2 whitespace-nowrap">
                    ...
                    <div class="text-xs text-green-600">Dept Approved</div>
                </td>
                <td class="px-6 py-2">
                    ...
                    <div class="text-xs text-gray-400">{$req['department_name']}</div>
                </td>
                <td class="px-6 py-2">
                ...
                <td class="px-6 py-2">
                    <div class="text-sm text-gray-900">{$req['dept_mgr_name']}</div>
                </td>
...
<div id="approvalModal" class="hidden fixed z-10 inset-0 overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4">
        ...
        <div class="relative bg-white rounded-lg max-w-lg w-full p-6">
            ...
            <form id="approvalForm" action="/asset-requests/it-approvals/process" method="POST">
...
function showApprovalModal(requestId, action, requestNumber) {
    ...
    if (action === 'approve') {
        title.textContent = 'Approve Request (IT Manager)';
